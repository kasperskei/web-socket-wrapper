...
export class WebSocketChannel {
  ...
  on(eventName: EventName, handler: EventHandler, wrappedHandler: EventHandler = handler) {
    return this.wrapper.on(this.joinPath(eventName), handler, wrappedHandler)
  }

  once(eventName: EventName, handler: EventHandler, wrappedHandler: EventHandler = handler) {
    return this.wrapper.once(this.joinPath(eventName), handler, wrappedHandler)
  }
  ...
  set(key: string, value: any) {
    return this.wrapper.set(key, value)
  }
}
